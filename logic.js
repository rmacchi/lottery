...
function renderBoard() {
  var divBoard = document.querySelector('#loteria-board');
  divBoard.innerHTML = '';
...
function renderButtons() {
  var divButtons = document.querySelector('#loteria-buttons');
...
function renderSavedGames() {
  var divSavedGames = document.querySelector('#loteria-saved-games');
